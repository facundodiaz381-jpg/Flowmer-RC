...
export const seedGames: Game[] = [
  ...
  },
  {
    ...
    image:
      "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/219740/88641e235d75934ea9f7ed4e947edfd9da682732/header.jpg?t=1781206408",
    trailerUrl: "https://www.youtube.com/embed/bVbyn7c1X6E?si=zS45cV3oklDVHOqm",
    ...
    systemRequirements: {
      ...
      memory: "1 GB de RAM",
      graphics: "Radeon HD5450 o superior",
  ...
  },
  {
    ...
    systemRequirements: {
      ...
      processor: "intel I5",
      memory: "8 GB de RAM",
      graphics: "2 GB de VRAM.",
      storage: "8 GB de espacio libre",
    },
    upvotes: 9000,
    downvotes: 50,
  },
